...
{
    internal class AuditGenerator : Feature
    {
        protected override void Setup(FeatureConfigurationContext context)
        {
            context.Container.ConfigureComponent<GenerateLoad>(DependencyLifecycle.SingleInstance);
            context.RegisterStartupTask(builder => builder.Build<GenerateLoad>());
        }

        private class GenerateLoad : FeatureStartupTask
        {
...
<MyMessage xmlns:xsi=""http://www.w3.org/2001/XMLSchema-instance"" xmlns:xsd=""http://www.w3.org/2001/XMLSchema""
   ...
   <MyProperty>{new string('a', 13 * 1024)}</MyProperty>
            ...
            public GenerateLoad(IDispatchMessages dispatchMessages) => this.dispatchMessages = dispatchMessages;
